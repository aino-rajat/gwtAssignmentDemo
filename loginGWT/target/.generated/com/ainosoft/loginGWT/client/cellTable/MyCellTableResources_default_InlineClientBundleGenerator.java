...
public class MyCellTableResources_default_InlineClientBundleGenerator implements com.ainosoft.loginGWT.client.cellTable.MyCellTableResources {
  private static MyCellTableResources_default_InlineClientBundleGenerator _instance0 = new MyCellTableResources_default_InlineClientBundleGenerator();
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.ainosoft.loginGWT.client.cellTable.MyCellTableResources.TableStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GJEROWPCG{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCA{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCFB{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GJEROWPCFB:hover{color:" + ("#6c6b6b")  + ";}.GJEROWPCB{background:" + ("#fff")  + ";}.GJEROWPCC{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GJEROWPCBB{background:" + ("#f3f7fb")  + ";}.GJEROWPCCB{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GJEROWPCI{background:" + ("#eee")  + ";}.GJEROWPCJ{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GJEROWPCL{background:" + ("#ffc")  + ";}.GJEROWPCM{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GJEROWPCDB{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GJEROWPCEB{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GJEROWPCK{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GJEROWPCAB{margin:") + (("30px")  + ";}.GJEROWPCIB{color:" + ("#729fcf")  + ";background-color:" + ("#f0f")  + ";}.GJEROWPCH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("12px"+ " " +"120px")  + ";text-align:" + ("right")  + ";color:" + ("#100202")  + ";background-color:" + ("skyblue")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCA{padding:" + ("2px"+ " " +"15px") ) + (";overflow:" + ("hidden")  + ";text-align:" + ("center")  + ";cursor:" + ("pointer")  + ";}.GJEROWPCJ{color:" + ("#c23939")  + ";background-color:" + ("antiquewhite")  + ";}")) : ((".GJEROWPCG{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCA{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCFB{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GJEROWPCFB:hover{color:" + ("#6c6b6b")  + ";}.GJEROWPCB{background:" + ("#fff")  + ";}.GJEROWPCC{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GJEROWPCBB{background:" + ("#f3f7fb")  + ";}.GJEROWPCCB{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GJEROWPCI{background:" + ("#eee")  + ";}.GJEROWPCJ{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GJEROWPCL{background:" + ("#ffc")  + ";}.GJEROWPCM{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GJEROWPCDB{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GJEROWPCEB{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GJEROWPCK{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GJEROWPCAB{margin:") + (("30px")  + ";}.GJEROWPCIB{color:" + ("#729fcf")  + ";background-color:" + ("#f0f")  + ";}.GJEROWPCH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("12px"+ " " +"120px")  + ";text-align:" + ("left")  + ";color:" + ("#100202")  + ";background-color:" + ("skyblue")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCA{padding:" + ("2px"+ " " +"15px") ) + (";overflow:" + ("hidden")  + ";text-align:" + ("center")  + ";cursor:" + ("pointer")  + ";}.GJEROWPCJ{color:" + ("#c23939")  + ";background-color:" + ("antiquewhite")  + ";}"));
      }
  ...
  private static class cellTableStyleInitializer {
    ...
    static com.ainosoft.loginGWT.client.cellTable.MyCellTableResources.TableStyle get() {
      return cellTableStyle;
    }
  }
  public com.ainosoft.loginGWT.client.cellTable.MyCellTableResources.TableStyle cellTableStyle() {
  ...
  private static com.ainosoft.loginGWT.client.cellTable.MyCellTableResources.TableStyle cellTableStyle;
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'cellTableStyle': return this.@com.ainosoft.loginGWT.client.cellTable.MyCellTableResources::cellTableStyle()();
    }
    return null;
  }-*/;
}
