...
public class LoginService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    var result = {};
    result["com.ainosoft.loginGWT.client.LoginSlim/398475846"] = [
        ,
        ,
        @com.ainosoft.loginGWT.client.LoginSlim_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/ainosoft/loginGWT/client/LoginSlim;)
      ];
    
    result["com.ainosoft.loginGWT.client.addCellTableRecord.AddUserRecordSlim/2754951301"] = [
        @com.ainosoft.loginGWT.client.addCellTableRecord.AddUserRecordSlim_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.ainosoft.loginGWT.client.addCellTableRecord.AddUserRecordSlim_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/ainosoft/loginGWT/client/addCellTableRecord/AddUserRecordSlim;),
        @com.ainosoft.loginGWT.client.addCellTableRecord.AddUserRecordSlim_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/ainosoft/loginGWT/client/addCellTableRecord/AddUserRecordSlim;)
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    var result = [];
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.ainosoft.loginGWT.client.LoginSlim::class)] = "com.ainosoft.loginGWT.client.LoginSlim/398475846";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.ainosoft.loginGWT.client.addCellTableRecord.AddUserRecordSlim::class)] = "com.ainosoft.loginGWT.client.addCellTableRecord.AddUserRecordSlim/2754951301";
