  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GJEROWPCNE{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCOE{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCHE{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCMF{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GJEROWPCMF:hover{color:" + ("#6c6b6b")  + ";}.GJEROWPCIE{background:" + ("#fff")  + ";}.GJEROWPCJE{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GJEROWPCIF{background:" + ("#f3f7fb")  + ";}.GJEROWPCJF{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GJEROWPCPE{background:" + ("#eee")  + ";}.GJEROWPCAF{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GJEROWPCCF{background:" + ("#ffc")  + ";}.GJEROWPCDF{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GJEROWPCKF{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GJEROWPCLF{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GJEROWPCBF{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GJEROWPCHF{margin:") + (("30px")  + ";}")) : ((".GJEROWPCNE{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCOE{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCHE{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GJEROWPCMF{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GJEROWPCMF:hover{color:" + ("#6c6b6b")  + ";}.GJEROWPCIE{background:" + ("#fff")  + ";}.GJEROWPCJE{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GJEROWPCIF{background:" + ("#f3f7fb")  + ";}.GJEROWPCJF{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GJEROWPCPE{background:" + ("#eee")  + ";}.GJEROWPCAF{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GJEROWPCCF{background:" + ("#ffc")  + ";}.GJEROWPCDF{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GJEROWPCKF{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GJEROWPCLF{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GJEROWPCBF{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GJEROWPCHF{margin:") + (("30px")  + ";}"));
      }
